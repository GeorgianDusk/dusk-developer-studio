...
```bash
npx dusk-developer-studio@1.0.13
```
...
```bash
npx dusk-developer-studio@1.0.13 local-actions
```
...
```bash
npm exec --ignore-scripts --package=dusk-developer-studio@1.0.13 -- dusk-developer-studio
npm exec --ignore-scripts --package=dusk-developer-studio@1.0.13 -- dusk-developer-studio local-actions
```

Replace `1.0.13` with another reviewed version when needed. Never combine files from different package versions.
