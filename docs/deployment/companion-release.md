...
```bash
npm exec --ignore-scripts --package=dusk-developer-studio@1.0.12 -- dusk-developer-studio
npm exec --ignore-scripts --package=dusk-developer-studio@1.0.12 -- dusk-developer-studio local-actions
```

Replace `1.0.12` with another reviewed version when needed. Never combine files from different package versions.
