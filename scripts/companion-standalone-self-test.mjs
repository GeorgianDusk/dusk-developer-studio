...
import {
  STANDALONE_LIFECYCLE_RESULT_PREFIX as RESULT_PREFIX,
  STANDALONE_MODES as MODES,
  STANDALONE_TARGETS as TARGETS,
...
export { validateStandaloneSelfTestResult } from "./standalone-candidate-lifecycle-core.mjs";
