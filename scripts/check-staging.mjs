...
if (!baseUrl) {
  console.error("Usage: node scripts/check-staging.mjs --url=https://approved-host --environment=staging --rpc-degradation=success [--commit=40-character-sha] [--out=output/receipt.json]");
  process.exit(2);
}
