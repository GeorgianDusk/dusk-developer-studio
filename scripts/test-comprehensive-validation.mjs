...
unintendedCandidate.final_candidate.package_version = "9.9.9";
unintendedCandidate.final_candidate.repository_tag = "v9.9.9";
assert.match(
...
assert.equal(tarballInspection.package_version, "1.0.12");
