...
async function fixture(): Promise<string> {
  ...
  const files = new Map<string, string>([
    ...
    ["templates/hardhat-counter-dusk-evm/.gitignore.template", "artifacts/\ncache/\n"],
    ["templates/hardhat-counter-dusk-evm/README.md", "# Hardhat Counter\n"],
    ["templates/hardhat-counter-dusk-evm/package.json", "{\"private\":true}\n"],
    ["templates/hardhat-counter-dusk-evm/package-lock.json", "{\"lockfileVersion\":3}\n"],
    ["templates/hardhat-counter-dusk-evm/hardhat.config.ts", "export default {};\n"],
    ["templates/hardhat-counter-dusk-evm/contracts/Counter.sol", "contract Counter {}\n"],
    ["templates/hardhat-counter-dusk-evm/ignition/modules/Counter.ts", "export default {};\n"],
    ["templates/hardhat-counter-dusk-evm/test/Counter.t.sol", "contract CounterTest {}\n"],
