...
/// DuskStudioTemplateProject contract with basic increment/decrement functionality.
#[dusk_forge::contract]
mod dusk_studio_template_project {
    use dusk_core::abi;

    /// Contract state.
    pub struct DuskStudioTemplateProject {
        /// Current count value.
        value: u64,
    }

    impl DuskStudioTemplateProject {
